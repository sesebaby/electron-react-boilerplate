...
// Legacy underscore-prefixed exports
...
export const _getBarColor = getBarColor;
export const _calculatePercentage = calculatePercentage;
export const _findMaxValue = findMaxValue;
