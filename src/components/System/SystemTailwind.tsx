...
import UserManagementTailwind from './UserManagementTailwind';
...
export const SystemTailwind: React.FC<SystemProps> = ({ className }) => {
    ...
    >
      <div className="p-6 space-y-6">
        ...
        <div className="tab-content">
          {activeTab === 'users' && <UserManagementTailwind />}
