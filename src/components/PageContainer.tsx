...
import InventoryCardView from './Reports/AnalysisViews/InventoryCardView';
import CalendarOverviewPage from './Reports/AnalysisViews/CalendarOverviewPage';
import DailyConsumptionView from './Reports/AnalysisViews/DailyConsumptionView';
