...
const ConsumptionTableRow: React.FC<ConsumptionTableRowProps> = ({
  ...
  const renderCategoryRow = () => {
    ...
    return (
      <tr className={getRowStyle()}>
        {/* 分类名称列 */}
        <td className="sticky left-0 z-10 bg-white/5 backdrop-blur-lg px-4 py-3 border-r border-white/20">
  ...
  const renderProductRow = () => {
    ...
    return (
      <tr className={getRowStyle()}>
        {/* 产品名称列 */}
        <td className="sticky left-0 z-10 bg-white/3 backdrop-blur-lg px-4 py-3 border-r border-white/20">
